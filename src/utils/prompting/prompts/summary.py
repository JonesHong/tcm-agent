...
word_limit = 50
user_prompt_prefix = (
    f"以下整句話濃縮總結成，一定要控制字數在{word_limit}字以下的重點句子\n- - - -\n"
)
prompt_service_factory.create_prompt_service(
    ...
    example_prompts=[
        ...
        (
            ...
            "建议使用刘某的中药方「平热散」治疗头痛和发热，强调避免辛辣食物，并在无效时咨询医生。",
        ),
    ],
    # llm=
)
...
# summary_agent.test_examples(examples=examples,method="invoke", measure_performance=True)
